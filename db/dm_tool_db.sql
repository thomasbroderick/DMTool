...
-- -----------------------------------------------------
-- Table `dm_tool_db`.`campaign_notes`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dm_tool_db`.`campaign_notes` ;

CREATE TABLE IF NOT EXISTS `dm_tool_db`.`campaign_notes` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
CREATE INDEX `fk_campaign_notes_idx` ON `dm_tool_db`.`campaign_notes` (`campaign_id` ASC);
...
-- -----------------------------------------------------
-- Table `dm_tool_db`.`character_notes`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dm_tool_db`.`character_notes` ;

CREATE TABLE IF NOT EXISTS `dm_tool_db`.`character_notes` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
CREATE INDEX `fk_character_notes_idx` ON `dm_tool_db`.`character_notes` (`character_id` ASC);
...
CREATE TABLE IF NOT EXISTS `dm_tool_db`.`monster` (
  ...
  `vulnerability` MEDIUMTEXT NULL DEFAULT NULL,
  `resistance` MEDIUMTEXT NULL DEFAULT NULL,
  `immunity` MEDIUMTEXT NULL DEFAULT NULL,
  `condition_immunity` MEDIUMTEXT NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Data for table `dm_tool_db`.`campaign_notes`
-- -----------------------------------------------------
START TRANSACTION;
USE `dm_tool_db`;
INSERT INTO `dm_tool_db`.`campaign_notes` (`id`, `campaign_id`, `text`) VALUES (1, 1, 'Boss fight coming up!');
...
-- -----------------------------------------------------
-- Data for table `dm_tool_db`.`character_notes`
-- -----------------------------------------------------
START TRANSACTION;
USE `dm_tool_db`;
INSERT INTO `dm_tool_db`.`character_notes` (`id`, `character_id`, `text`) VALUES (1, 1, 'Best character evar!');
...
START TRANSACTION;
USE `dm_tool_db`;
INSERT INTO `dm_tool_db`.`monster` (`id`, `user_id`, `name`, `size`, `type`, `subtype`, `alignment`, `armor_class`, `hit_points`, `hit_dice`, `speed`, `strength`, `dexterity`, `intelligence`, `wisdom`, `charisma`, `constitution`, `dexterity_save`, `charisma_save`, `wisdom_save`, `stealth`, `vulnerability`, `resistance`, `immunity`, `condition_immunity`, `senses`, `languages`, `challenge_rating`, `special_abilities`, `actions`, `legendary_actions`, `image_url`) VALUES (1, 1, 'Goblin', 'Medium', 'Goblinoid', NULL, NULL, 10, 10, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
